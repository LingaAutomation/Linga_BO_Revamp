...
public class UpchargesPage {
	...
	public void Select_CategoryType() throws Exception
	{
		...
		List<WebElement> CategoryList=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
		...
		driver.findElement(By.xpath("//div[@class='option-list']/div/select-option["+randomCategory+"]")).click();
		}
		else
		{
		...
		Thread.sleep(1000);
		Thread.sleep(1000);
		List<WebElement> CategoryList1=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
...
//		try
//		{
//		if(driver.findElement(By.xpath("//div[@class='option-list']/div/select-option")).isDisplayed())
//		{
//			List<WebElement> CategoryList=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
//			
//			int CategorySize=CategoryList.size();
...
//		}
	...
	public void Select_SubCategoryType() throws Exception
	{
		...
		Thread.sleep(1000);
		List<WebElement> SubCategoryList=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
		...
		int SubCategorySize=SubCategoryList.size();
			...
			driver.findElement(By.xpath("//div[@class='option-list']/div/select-option["+randomSubCategory+"]")).click();
			}
			else
			{
			...
			Thread.sleep(1000);
			List<WebElement> SubCategoryList1=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
	...
	public void Select_MenuItemType() throws Exception
	{
		...
		for(int i=1;i<=3;i++)
		{
			...
			List<WebElement> MenuItemList=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
			...
			if(MenuItemSize<=6)
			{
				...
				driver.findElement(By.xpath("//div[@class='option-list']/div/select-option["+randomMenuItem+"]")).click();
				Thread.sleep(1000);
			}
			else
			{
			...
			Thread.sleep(2000);
				List<WebElement> MenuItemList1=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
