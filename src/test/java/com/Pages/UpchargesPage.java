...
public class UpchargesPage {
	...
	@FindBy(xpath = "//span[contains(.,'DAYS OF WEEK')]/../../div[2]/app-toggle/div/mat-button-toggle-group/mat-button-toggle[contains(.,'Yes')]")
	WebElement DAYS_OF_WEEk_YesBtn;
		
	@FindBy(xpath = "//span[contains(.,'DAYS OF WEEK')]/../../div[2]/app-toggle/div/mat-button-toggle-group/mat-button-toggle[contains(.,'No')]")
	WebElement ADAYS_OF_WEEk__NoBtn;
