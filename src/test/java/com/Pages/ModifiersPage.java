...
public class ModifiersPage {
	...
	@FindBy(xpath = "//span[contains(.,'Show Menu Item In Modifier Print')]/../../div[2]/app-toggle/div/mat-button-toggle-group/mat-button-toggle[contains(.,'Yes')]")
	WebElement ShowMenuItemModiInPrint_YesBtn;
	
	@FindBy(xpath = "//span[contains(.,'Show Menu Item In Modifier Print')]/../../div[2]/app-toggle/div/mat-button-toggle-group/mat-button-toggle[contains(.,'No')]")
