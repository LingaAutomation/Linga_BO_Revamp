...
//		{
		Thread.sleep(1000);
		List<WebElement> departList=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
		...
		driver.findElement(By.xpath("//div[@class='option-list']/div/select-option["+randomDept+"]")).click();
//		}
//		catch(Exception e)
//		{
...
//		CoursingDropBtn.click();
		...
		Thread.sleep(1000);
		List<WebElement> courseList=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[@class='option-list']/div/select-option["+randomCoursing+"]")).click();
		}
		else
		{
...
//		ServingSizeLevelDropBtn.click();
		...
		List<WebElement> ServSizeLvlList=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
...
//		TareGroupDropBtn.click();
		...
		Thread.sleep(1000);
		List<WebElement> tareGrpList=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
		...
		driver.findElement(By.xpath("//div[@class='option-list']/div/select-option["+randomTareGrp+"]")).click();
...
//		ItemServiceChargeDropBtn.click();
		...
		List<WebElement> itemServChargeList=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
		...
		driver.findElement(By.xpath("//div[@class='option-list']/div/select-option["+randomItemServCharge+"]")).click();
		}
		else
		{
		...
		List<WebElement> itemServChargeList1=driver.findElements(By.xpath("//div[@class='option-list']/div/select-option"));
