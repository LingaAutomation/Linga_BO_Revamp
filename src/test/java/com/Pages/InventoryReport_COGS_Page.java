...
public class InventoryReport_COGS_Page extends BasePage
{
...
//		public ExtentTest test;
		...
		TaxesPage tx;
		public InventoryReport_COGS_Page(SelfHealingDriver driver,ExtentTest test)
		{
//			this.driver=driver;
//			this.test=test;
		...
		@FindBy(xpath = "//label[contains(.,' COGS Type ')]/../../input")
		WebElement CogosType_ReportInputBx;
		
		@FindBy(xpath = "(//label[contains(.,'Type')]/../../input)[2]")
		...
		@FindBy(xpath = "//span[contains(@class,'no-data-title')][contains(.,'Inventory not found')]")
		WebElement No_Inventory_Found_InfoMsg;
		
		@FindBy(xpath = "//span[contains(@class,'no-data-title')][contains(.,'Modifiers not Found')]")
		WebElement No_MenuItem_Found_InfoMsg;
		
		@FindBy(xpath = "//span[contains(@class,'no-data-title')][contains(.,'Department not found')]")
		WebElement No_Department_Found_InfoMsg;
		...
		public WebElement No_Inventory_Found_InfoMsg()
		{
			return No_Inventory_Found_InfoMsg;
		}
		
		
		public WebElement No_MenuItem_Found_InfoMsg()
		{
			return No_MenuItem_Found_InfoMsg;
		}
		
		public WebElement No_Department_Found_InfoMsg()
		{
			return No_Department_Found_InfoMsg;
		}
		
		public void Select_Cogs_type_Product_Item() throws InterruptedException
		{
			Thread.sleep(1000);
		...
		public void Select_Cogs_type_Inventory_Item() throws InterruptedException
		{
			Thread.sleep(1000);
			CogosType_ReportInputBx.click();
			Thread.sleep(1000);
		...
		public void Select_type_Modifier() throws InterruptedException
		{
			Thread.sleep(1000);
			TYpe_InputBx.click();
			Thread.sleep(1000);
