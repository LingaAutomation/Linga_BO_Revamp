...
public class DiscountsPage {
	...
	public DiscountsPage(WebDriver driver,ExtentTest test)
	{
		this.driver=driver;
		this.test=test;
	...
	public void Select_Serving_Size() throws Exception
	{
		...
		Serving_SizeInputBx.click();
		Thread.sleep(1000);
		//List<WebElement> CategoryList=driver.findElements(By.xpath("//div[contains(@class,'options')]/select-option"));
		...
		driver.findElement(By.xpath("//div[contains(@class,'options')]/select-option[2]")).click();
	
		Thread.sleep(1000);
		
		Thread.sleep(1000);
		List<WebElement> CategoryList1=driver.findElements(By.xpath("//div[contains(@class,'options')]/select-option"));
		if(CategoryList1.size()!=0) {
			test.log(LogStatus.FAIL, "Serving Size Lists are displayed, after selecting the required Serving Size");
			Serving_SizeInputBx.click();
		}
		}
	}
...
//		
	...
	public void Select_Exclude_Category() throws Exception
	{
		...
		driver.findElement(By.xpath("//div[contains(@class,'options')]/select-option["+randomCategory+"]")).click();
	...
	public void Select_Exclude_MenuItems() throws Exception
	{
		...
		List<WebElement> CategoryList1=driver.findElements(By.xpath("//div[contains(@class,'options')]/select-option"));
		if(CategoryList1.size()!=0) {
			test.log(LogStatus.FAIL, "Menu Item Lists are displayed, after selecting the required menu item");
			MenuItem_InputBox.click();
		}
		}
