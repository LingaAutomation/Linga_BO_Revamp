...
//		driver = new ChromeDriver();
	...
	public void Open_WeeklySummary_Sales_Page(WebDriver driver) throws Exception
	{
	...
	public void Old_BO_WeeklySummary_Report_Last_Week(WebDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
