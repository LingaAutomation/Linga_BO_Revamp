...
//		driver=new ChromeDriver(chrOpt);
	...
	public void Save_Epson_Box_Label_Template_Settings(SelfHealingDriver driver) throws Exception
	{
		cmp=new Common_XPaths(driver, test);
		ltp=new Label_TemplatePage(driver, test);
		Thread.sleep(2000);
...
//						}
	...
	public void Save_Zebra_Label_Template_Settings(SelfHealingDriver driver) throws Exception
	{
		cmp=new Common_XPaths(driver, test);
...
//				ltp.Click_Zebra_LabelTemplate();
	...
	@Test(priority = 5,enabled = false)
	public void Save_Kitchen_Label_Template_Settings(SelfHealingDriver driver) throws Exception
	{
		cmp=new Common_XPaths(driver, test);
