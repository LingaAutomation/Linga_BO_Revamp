...
public class Enterprise_Add_Edit_Central_Kitchen
{
...
//		RefreshAndPaginination(driver);
		...
		Delete_and_Active_Inactive_Central_Kitchen(driver);
		Create_Duplicate_Central_Kitchen(driver);
		Central_Kitchen_Report(driver);
	}
	
	@Test(priority = 3,enabled = false)
	public void Open_Central_Kitchen_Page(WebDriver driver) throws Exception
	{
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	public void Add_Central_Kitchen(WebDriver driver) throws Exception
	{
		civ=new Enterprise_CentralIventoryPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	public void Edit_and_Close_Cancel_Central_Kitchen(WebDriver driver) throws Exception
	{
		cmp=new Common_XPaths(driver, test);
		civ=new Enterprise_CentralIventoryPage(driver, test);
	...
	public void Edit_and_Update_Central_Kitchen(WebDriver driver) throws Exception
	{
		cmp=new Common_XPaths(driver, test);
		civ=new Enterprise_CentralIventoryPage(driver, test);
...
//		cmp.SearchAndVerify_SearchBox();
		...
		if(cmp.ConfirmationAlertMsg().getText().equalsIgnoreCase("Central Kitchen Updated Successfully"))
		{
			test.log(LogStatus.PASS, "Central Kitchen Updated Successfully Enabled with Copy from Existing Store");
		
			ut.PassedCaptureScreenshotAsBASE64(driver, test);
		}
		else
		{
			test.log(LogStatus.FAIL, "Central Kitchen Updated Failed Enabled with Copy from Existing Store");
		...
		if(cmp.ConfirmationAlertMsg().getText().equalsIgnoreCase("Central Kitchen Updated Successfully"))
		{
			test.log(LogStatus.PASS, "Central Kitchen Updated Successfully Disabled with Copy from Existing Store");
		
			ut.PassedCaptureScreenshotAsBASE64(driver, test);
		}
		else
		{
			test.log(LogStatus.FAIL, "Central Kitchen Updated Failed Disabled with Copy from Existing Store");
	...
	public void Delete_and_Active_Inactive_Central_Kitchen(WebDriver driver) throws Exception
	{
		Thread.sleep(500);
		...
		cmp.SearchAndClickDelete(Utility.getProperty("New_Central_Kitchen"));
		...
		if(cmp.ConfirmationAlertMsg().getText().equalsIgnoreCase("Central Kitchen Inactivated Successfully"))
		{
			test.log(LogStatus.FAIL, "Central Kitchen Deleted when clicking Cancel button");
		...
		{
			test.log(LogStatus.PASS, "Central Kitchen not Deleted when Clicking Cancel button");
		...
		if(cmp.ConfirmationAlertMsg().getText().equalsIgnoreCase("Central Kitchen Inactivated Successfully"))
		{
			test.log(LogStatus.PASS, "Central Kitchen Inactivated Successfully");
		
			ut.PassedCaptureScreenshotAsBASE64(driver, test);
		}
		else
		{
			test.log(LogStatus.FAIL, "Central Kitchen Inactivated Failed");
		...
		cmp.SearchAndClickActivate(Utility.getProperty("New_Central_Kitchen"));
		...
		try
		{
			Thread.sleep(3000);
			//Check whether the New Modifier Saved or not
			if(cmp.ConfirmationAlertMsg().getText().equalsIgnoreCase("Central Kitchen Activated Successfully"))
			{
				test.log(LogStatus.FAIL, "Central Kitchen Activated when clicking Cancel button");
		...
		{
				test.log(LogStatus.PASS, "Central Kitchen not Activated when Clicking Cancel button");
		...
		if(cmp.ConfirmationAlertMsg().getText().equalsIgnoreCase("Central Kitchen Activated Successfully"))
		{
			test.log(LogStatus.PASS, "Central Kitchen Activated Successfully");
		
			ut.PassedCaptureScreenshotAsBASE64(driver, test);
		}
		else
		{
			test.log(LogStatus.FAIL, "Central Kitchen Activated Failed");
	...
	public void Create_Duplicate_Central_Kitchen(WebDriver driver) throws Exception
	{
		civ=new Enterprise_CentralIventoryPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 9,enabled = false)
	public void Central_Kitchen_Report(WebDriver driver) throws Exception
	{
		civ=new Enterprise_CentralIventoryPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		...
		driver.findElement(By.xpath("//div[@class='central-Kitchen-content']//span[.='"+Utility.getProperty("New_Central_Kitchen")+"']")).click();
