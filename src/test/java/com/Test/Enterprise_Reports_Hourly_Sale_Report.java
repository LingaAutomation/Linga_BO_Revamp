...
public WebDriver driver;
	...
	ExtentTest test = rep.startTest("Enterprise Reports - Hourly Sale Report");
...
//		driver=new ChromeDriver(chrOpt);
	...
	{
		Open_Enterprise_Hourly_Sale_Report_Page(driver);
//		RefreshAndPaginination(driver);
		Enterprise_Hourly_Sale_Report_Today(driver);
		Enterprise_Hourly_Sale_Report_Yesterday(driver);
		Enterprise_Hourly_Sale_Report_Last_N_Days(driver);
		Enterprise_Hourly_Sale_Report_This_Week(driver);
		Enterprise_Hourly_Sale_Report_Last_Week(driver);
		Enterprise_Hourly_Sale_Report_Last_7_Days(driver);
		Enterprise_Hourly_Sale_Report_This_Month(driver);
		Enterprise_Hourly_Sale_Report_Last_Month(driver);
		Enterprise_Hourly_Sale_Report_Last_30_Days(driver);
		Enterprise_Hourly_Sale_Report_Specific_Date(driver);
		Enterprise_Hourly_Sale_Report_Date_Range(driver);
	}
	...
	public void Open_Enterprise_Hourly_Sale_Report_Page(WebDriver driver) throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"enterprise/enterpriseReports/saleReports/hourly");

		Thread.sleep(5000);
		try
		{
			//Verify the Menu Item sales report page loaded or not
			repts.Verify_ReportHomePage("HOURLY SALE");
		}
		catch(Exception k)
		{
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	public void Enterprise_Hourly_Sale_Report_Today(WebDriver driver) throws Exception
	{
		...
		{
			test.log(LogStatus.INFO, "Enterprise Sale Report for Hourly Sale Not Available for Today");
		...
		catch(Exception G)
		{
			...
			test.log(LogStatus.PASS, "Enterprise Sale Report for Hourly Sale Available for Today");
...
//				excel.Highlight_DifferenceValue();
	...
	public void Enterprise_Hourly_Sale_Report_Yesterday(WebDriver driver) throws Exception
	{
		...
		if(repts.No_TransactionFound_InfoMessage().isDisplayed())
		{
			test.log(LogStatus.INFO, "Enterprise Sale Report for Hourly Sale Not Available for Yesterday");
		...
		catch(Exception G)
		{
			...
			test.log(LogStatus.PASS, "Enterprise Sale Report for Hourly Sale Available for Yesterday");
...
//				excel.Highlight_DifferenceValue();
	...
	public void Enterprise_Hourly_Sale_Report_Last_N_Days(WebDriver driver) throws Exception
	{
		...
		if(repts.No_TransactionFound_InfoMessage().isDisplayed())
		{
			test.log(LogStatus.INFO, "Enterprise Sale Report for Hourly Sale Not Available for Last N days");
		...
		catch(Exception G)
		{
			...
			test.log(LogStatus.PASS, "Enterprise Sale Report for Hourly Sale Available for Last N days");
...
//				excel.Highlight_DifferenceValue();
	...
	public void Enterprise_Hourly_Sale_Report_This_Week(WebDriver driver) throws Exception
	{
		...
		if(repts.No_TransactionFound_InfoMessage().isDisplayed())
		{
			test.log(LogStatus.INFO, "Enterprise Sale Report for Hourly Sale Not Available for This Week");
		...
		catch(Exception G)
		{
			...
			test.log(LogStatus.PASS, "Enterprise Sale Report for Hourly Sale Available for This Week");
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	public void Enterprise_Hourly_Sale_Report_Last_Week(WebDriver driver) throws Exception
	{
		...
		if(repts.No_TransactionFound_InfoMessage().isDisplayed())
		{
			test.log(LogStatus.INFO, "Enterprise Sale Report for Hourly Sale Not Available for Last Week");
		...
		catch(Exception G)
		{
			...
			test.log(LogStatus.PASS, "Enterprise Sale Report for Hourly Sale Available for Last Week");
...
//				excel.Highlight_DifferenceValue();
	...
	public void Enterprise_Hourly_Sale_Report_Last_7_Days(WebDriver driver) throws Exception
	{
		...
		if(repts.No_TransactionFound_InfoMessage().isDisplayed())
		{
			test.log(LogStatus.INFO, "Enterprise Sale Report for Hourly Sale Not Available for Last 7 days");
		...
		catch(Exception G)
		{
			...
			test.log(LogStatus.PASS, "Enterprise Sale Report for Hourly Sale Available for Last 7 days");
...
//				excel.Highlight_DifferenceValue();
	...
	public void Enterprise_Hourly_Sale_Report_This_Month(WebDriver driver) throws Exception
	{
		...
		if(repts.No_TransactionFound_InfoMessage().isDisplayed())
		{
			test.log(LogStatus.INFO, "Enterprise Sale Report for Hourly Sale Not Available for This month");
		...
		catch(Exception G)
		{
			...
			test.log(LogStatus.PASS, "Enterprise Sale Report for Hourly Sale Available for This month");
...
//				excel.Highlight_DifferenceValue();
	...
	public void Enterprise_Hourly_Sale_Report_Last_Month(WebDriver driver) throws Exception
	{
		...
		if(repts.No_TransactionFound_InfoMessage().isDisplayed())
		{
			test.log(LogStatus.INFO, "Enterprise Sale Report for Hourly Sale Not Available for Last month");
		...
		catch(Exception G)
		{
			...
			test.log(LogStatus.PASS, "Enterprise Sale Report for Hourly Sale Available for Last month");
...
//				excel.Highlight_DifferenceValue();
	...
	public void Enterprise_Hourly_Sale_Report_Last_30_Days(WebDriver driver) throws Exception
	{
		...
		if(repts.No_TransactionFound_InfoMessage().isDisplayed())
		{
			test.log(LogStatus.INFO, "Enterprise Sale Report for Hourly Sale Not Available for Last 30 days");
		...
		catch(Exception G)
		{
			...
			test.log(LogStatus.PASS, "Enterprise Sale Report for Hourly Sale Available for Last 30 days");
...
//				excel.Highlight_DifferenceValue();
	...
	public void Enterprise_Hourly_Sale_Report_Specific_Date(WebDriver driver) throws Exception
	{
		...
		if(repts.No_TransactionFound_InfoMessage().isDisplayed())
		{
			test.log(LogStatus.INFO, "Enterprise Sale Report for Hourly Sale Not Available for Specific Date");
		...
		catch(Exception G)
		{
			...
			test.log(LogStatus.PASS, "Enterprise Sale Report for Hourly Sale Available for Specific Date");
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	public void Enterprise_Hourly_Sale_Report_Date_Range(WebDriver driver) throws Exception
	{
		...
		if(repts.No_TransactionFound_InfoMessage().isDisplayed())
		{
			test.log(LogStatus.INFO, "Enterprise Sale Report for Hourly Sale Not Available for Date Range");
		...
		catch(Exception G)
		{
			...
			test.log(LogStatus.PASS, "Enterprise Sale Report for Hourly Sale Available for Date Range");
