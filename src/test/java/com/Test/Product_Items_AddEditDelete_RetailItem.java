...
public WebDriver driver;
	...
	public void Open_ProductItem_RetailItem_Page(WebDriver driver) throws Exception
	{
		...
		driver.get("https://staging-linga.lingapos.com/newui/enterprise/stores");

		Thread.sleep(4000);
		driver.findElement(By.xpath("//app-input[contains(@placeholder,'Search')]/div/div/mat-form-field/div/div[1]/div[4]/input"))
		.sendKeys("Jio");
...
//		pmt.Enable_EBT_Menu_Item();
	...
	public void Edit_and_Close_Cancel_ProductItem_RetailItem(WebDriver driver) throws Exception
	{
	   ...
	   pmt.Click_RetailItem();
		
		Thread.sleep(5000);
		
		//Search the ProductItem_RetailItem_ to Click Edit and Cancel
		pmt.SearchAndClickEdit(Utility.getProperty("Product_Retail_Items_Name"));
...
//		}
		...
		if(cmp.ConfirmationAlertMsg().getText().equalsIgnoreCase("Retail Item Updated successfully"))
		{
			...
			Thread.sleep(3000);
			//Search and Click Edit button
			pmt.SearchAndClickEdit(Utility.getProperty("Product_Retail_Items_Name")+"1");
...
//		driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_UP);
	...
	public void Delete_and_Active_Inactive_ProductItem_RetailItem(WebDriver driver) throws Exception
	{
		...
		pmt.SearchAndClickDelete(Utility.getProperty("Product_Retail_Items_Name"));
		...
		//Search and Activate the In activated item
		pmt.SearchAndClickActivate(Utility.getProperty("Product_Retail_Items_Name"));
