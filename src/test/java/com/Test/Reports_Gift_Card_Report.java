...
public SelfHealingDriver driver;
	...
	ExtentTest test = rep.startTest("Reports - Gift Card Report");
...
//		driver=new ChromeDriver(chrOpt);
	...
	{
		Open_Gift_Card_Report_Page(driver);
//		RefreshAndPaginination(driver);
		Gift_Card_Report_Verify_Card_Search(driver);
		Gift_Card_Report_Today(driver);
		Gift_Card_Report_Yesterday(driver);
		Gift_Card_Report_Last_N_Days(driver);
		Gift_Card_Report_This_Week(driver);
		Gift_Card_Report_Last_Week(driver);
		Gift_Card_Report_Last_7_Days(driver);
		Gift_Card_Report_This_Month(driver);
		Gift_Card_Report_Last_Month(driver);
		Gift_Card_Report_Last_30_Days(driver);
		Gift_Card_Report_Specific_Date(driver);
		Gift_Card_Report_Date_Range(driver);
	}
	...
	public void Open_Gift_Card_Report_Page(SelfHealingDriver driver) throws Exception
	{
		...
		Thread.sleep(5000);
		//Load the Daily page
		driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id3")+"giftCardReport/giftCard");
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	public void Gift_Card_Report_Verify_Card_Search(SelfHealingDriver driver) throws Exception
	{
		...
		//Enter Gift Card Number
				...
				if(repts.No_TransactionFound_InfoMessage().isDisplayed())
				{
					test.log(LogStatus.INFO, "Gift Card Reports Not Available for Selected Time Period");
				...
				catch(Exception G)
				{
					...
					test.log(LogStatus.PASS, "Gift Card Reports Available for Selected Time Period");
