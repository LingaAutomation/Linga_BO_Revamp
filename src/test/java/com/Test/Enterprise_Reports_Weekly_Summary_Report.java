...
//		Enterprise_Weekly_Summary_Report_Specific_Date(driver);
	...
	public void Open_Enterprise_Weekly_Summary_Report_Page(WebDriver driver) throws Exception
	{
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Weekly_Summary_Report_This_Week(WebDriver driver) throws Exception
	{
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Weekly_Summary_Report_Last_Week(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Weekly_Summary_Report_Last_7_Days(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Weekly_Summary_Report_Specific_Date(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
