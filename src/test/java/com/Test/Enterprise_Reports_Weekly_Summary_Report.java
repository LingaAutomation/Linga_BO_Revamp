...
public class Enterprise_Reports_Weekly_Summary_Report 
{
...
public SelfHealingDriver driver;
	...
	ExtentTest test = rep.startTest("Enterprise Reports - Weekly Summary Report");
...
//		driver = new ChromeDriver();
	...
	{
		Open_Enterprise_Weekly_Summary_Report_Page(driver);
//		RefreshAndPaginination(driver);
//		Enterprise_Weekly_Summary_Report_This_Week(driver);
		Enterprise_Weekly_Summary_Report_Last_Week(driver);
		Enterprise_Weekly_Summary_Report_Last_7_Days(driver);
//		Enterprise_Weekly_Summary_Report_Specific_Date(driver);
	}
	
	@Test(priority = 3,enabled = false)
	public void Open_Enterprise_Weekly_Summary_Report_Page(SelfHealingDriver driver) throws Exception
	{
		...
		Thread.sleep(5000);
		//Load the Weekly Summary report page
		driver.get(Utility.getProperty("baseURL")+"enterprise/enterpriseReports/saleReports/weeklySummary");

		Thread.sleep(5000);
		try
		{
			//Verify the Weekly Summary sales report page loaded or not
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Weekly_Summary_Report_This_Week(SelfHealingDriver driver) throws Exception
	{
		...
		Thread.sleep(1000);
		//Click the Filtered Store to View Details
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Weekly_Summary_Report_Last_Week(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Weekly_Summary_Report_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Weekly_Summary_Report_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
