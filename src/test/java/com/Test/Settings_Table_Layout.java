...
public WebDriver driver;
	...
	ExtentTest test = rep.startTest("Table Layout");
	...
	public void Open_TableLayout_Page(WebDriver driver) throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id2")+"tableLayout");
