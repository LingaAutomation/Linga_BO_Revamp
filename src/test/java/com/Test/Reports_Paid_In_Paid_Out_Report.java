...
public SelfHealingDriver driver;
	...
	ExtentTest test = rep.startTest("Reports - Paid In / Paid Out Report");
...
//		System.setProperty("webdriver.chrome.driver",Utility.getProperty("Chrome_Paid_In_Paid_Out_Path"));
...
//		driver=new ChromeDriver(chrOpt);
	...
	{
		Open_Paid_In_Paid_Out_Report_Page(driver);
//		RefreshAndPaginination(driver);
		Paid_In_Paid_Out_Report_Verify_Paid_In_Paid_Out_Search(driver);
		Paid_In_Paid_Out_Report_Today(driver);
		Paid_In_Paid_Out_Report_Yesterday(driver);
		Paid_In_Paid_Out_Report_Last_N_Days(driver);
		Paid_In_Paid_Out_Report_This_Week(driver);
		Paid_In_Paid_Out_Report_Last_Week(driver);
		Paid_In_Paid_Out_Report_Last_7_Days(driver);
		Paid_In_Paid_Out_Report_This_Month(driver);
		Paid_In_Paid_Out_Report_Last_Month(driver);
		Paid_In_Paid_Out_Report_Last_30_Days(driver);
		Paid_In_Paid_Out_Report_Specific_Date(driver);
		Paid_In_Paid_Out_Report_Date_Range(driver);
	}
	
	@Test(priority = 3,enabled = false)
	public void Open_Paid_In_Paid_Out_Report_Page(SelfHealingDriver driver) throws Exception
	{
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_Verify_Paid_In_Paid_Out_Search(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	
		//Select Paid Type 
		repts.Select_Paid_Type("All");
		...
		Thread.sleep(2000);
				...
				if(repts.No_PaidIn_PaidOut_InfoMsg().isDisplayed())
				{
					test.log(LogStatus.INFO, "Paid In / Paid Out Reports Not Available for Selected Time Period");
				...
				catch(Exception G)
				{
					...
					test.log(LogStatus.PASS, "Paid In / Paid Out Reports Available for Selected Time Period");
					...
					//Select Paid Type 
					repts.Select_Paid_Type("Paid In");
					...
					//Select Paid Type 
					repts.Select_Paid_Type("Paid Out");
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_Today(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//			repts.Do_Pagination();
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_Yesterday(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_Last_N_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_This_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_Last_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_This_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_Last_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_Last_30_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Paid_In_Paid_Out_Report_Date_Range(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
