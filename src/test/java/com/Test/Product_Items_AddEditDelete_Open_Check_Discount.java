...
public WebDriver driver;
	...
	public void Calling() throws Exception
	{
		...
		Create_Duplicate_Open_Check_Discount(driver);
...
//Enable Discount In Amount
	...
	@Test(priority = 5,enabled = false)
	public void Edit_and_Update_MenuItem_Open_Check_Discount(WebDriver driver) throws Exception
	{
		cmp=new Common_XPaths(driver, test);
		dcp=new DiscountsPage(driver, test);
		at=new Availability_RestrictionTimePage(driver, test);
	...
	public void Delete_and_Active_Inactive_Open_Check_Discount(WebDriver driver) throws Exception
	{
		...
		cmp.SearchAndClickActivate(Utility.getProperty("DiscountName_OpenCheckAMT"));
	...
	public void Create_Duplicate_Open_Check_Discount(WebDriver driver) throws Exception
	{
		dcp=new DiscountsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		at=new Availability_RestrictionTimePage(driver, test);
		...
		Thread.sleep(60000);
		//Click the New Open Check Discount button
		dcp.Click_New_Open_Check_Discount();
		Thread.sleep(2000);
