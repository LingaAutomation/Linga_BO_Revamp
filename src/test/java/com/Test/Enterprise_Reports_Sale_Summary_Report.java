...
public class Enterprise_Reports_Sale_Summary_Report 
{
...
public SelfHealingDriver driver;
	...
	ExtentTest test = rep.startTest("Enterprise Reports - Sale Summary Report");
...
//		driver = new ChromeDriver();
	...
	{
		Open_Enterprise_Sale_Summary_Report_Page(driver);
//		RefreshAndPaginination(driver);
		Enterprise_Sale_Summary_Report_Today(driver);
		Enterprise_Sale_Summary_Report_Yesterday(driver);
		Enterprise_Sale_Summary_Report_Last_N_Days(driver);
		Enterprise_Sale_Summary_Report_This_Week(driver);
		Enterprise_Sale_Summary_Report_Last_Week(driver);
		Enterprise_Sale_Summary_Report_Last_7_Days(driver);
		Enterprise_Sale_Summary_Report_This_Month(driver);
		Enterprise_Sale_Summary_Report_Last_Month(driver);
		Enterprise_Sale_Summary_Report_Last_30_Days(driver);
		Enterprise_Sale_Summary_Report_Specific_Date(driver);
		Enterprise_Sale_Summary_Report_Date_Range(driver);
	}
	
	@Test(priority = 3,enabled = false)
	public void Open_Enterprise_Sale_Summary_Report_Page(SelfHealingDriver driver) throws Exception
	{
		...
		//Load the Menu Item sales report page
				driver.get(Utility.getProperty("baseURL")+"enterprise/enterpriseReports/saleReports/saleSummary");
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Sale_Summary_Report_Today(SelfHealingDriver driver) throws Exception
	{
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
			...
			String SaleAmount=driver.findElement(By.xpath("//tfoot/tr/td[6]")).getText().replace(",", "");
			...
			//Get the Tax
			String Tx=driver.findElement(By.xpath("//tfoot/tr/td[7]")).getText().replace(",", "");
			...
			//Get the Discount
			String Discnt=driver.findElement(By.xpath("//tfoot/tr/td[10]")).getText().replace(",", "");
			...
			String GrossReceipt=driver.findElement(By.xpath("//tfoot/tr/td[11]")).getText().replace(",", "");
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Sale_Summary_Report_Yesterday(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Sale_Summary_Report_Last_N_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Sale_Summary_Report_This_Week(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Sale_Summary_Report_Last_Week(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Sale_Summary_Report_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Sale_Summary_Report_This_Month(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Sale_Summary_Report_Last_Month(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Sale_Summary_Report_Last_30_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Sale_Summary_Report_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Sale_Summary_Report_Date_Range(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
