...
//		driver = new ChromeDriver(chromeOptions);
	...
	public void Open_StoreLicenses_Page(SelfHealingDriver driver) throws Exception
	{
	...
	@Test(priority = 4,enabled = false)
	public void Pagination_Rows_Per_Count(SelfHealingDriver driver) throws Exception
	{
		slp=new StoreLicensesPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Revert_Licenses(SelfHealingDriver driver) throws Exception
	{
		slp=new StoreLicensesPage(driver, test);
		cmp=new Common_XPaths(driver, test);
