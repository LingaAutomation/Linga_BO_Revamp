...
//		driver = new ChromeDriver();
	...
	public void Open_SaleSummary_Sales_Page(WebDriver driver) throws Exception
	{
	...
	public void Old_BO_SaleSummary_Report_Date_Range(WebDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
