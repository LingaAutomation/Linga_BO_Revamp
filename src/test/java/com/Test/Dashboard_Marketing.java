...
//		driver=new ChromeDriver(chrOpt);
	...
	public void Open_Dashboard_Marketing_Page(SelfHealingDriver driver) throws Exception
	{
	...
	public void Dashboard_Marketing_Today(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Marketing_Yesterday(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Marketing_Last_N_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Marketing_This_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Marketing_Last_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Marketing_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Marketing_This_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Marketing_Last_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Marketing_Last_30_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Marketing_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Marketing_Date_Range(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
