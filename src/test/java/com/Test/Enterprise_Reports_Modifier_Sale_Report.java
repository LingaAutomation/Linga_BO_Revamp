...
public class Enterprise_Reports_Modifier_Sale_Report 
{
...
public SelfHealingDriver driver;
	...
	ExtentTest test = rep.startTest("Enterprise Reports - Modifier Sale Report");
...
//		driver = new ChromeDriver(chromeOptions);
	...
	{
		Open_Enterprise_Report_Modifier_Report_Page(driver);
//		RefreshAndPaginination(driver);
		Enterprise_Report_Modifier_Report_Today(driver);
		Enterprise_Report_Modifier_Report_Yesterday(driver);
		Enterprise_Report_Modifier_Report_Last_N_Days(driver);
		Enterprise_Report_Modifier_Report_This_Week(driver);
		Enterprise_Report_Modifier_Report_Last_Week(driver);
		Enterprise_Report_Modifier_Report_Last_7_Days(driver);
		Enterprise_Report_Modifier_Report_This_Month(driver);
		Enterprise_Report_Modifier_Report_Last_Month(driver);
		Enterprise_Report_Modifier_Report_Last_30_Days(driver);
		Enterprise_Report_Modifier_Report_Specific_Date(driver);
		Enterprise_Report_Modifier_Report_Date_Range(driver);
	}
	
	@Test(priority = 3,enabled = false)
	public void Open_Enterprise_Report_Modifier_Report_Page(SelfHealingDriver driver) throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"enterprise/enterpriseReports/saleReports/modifier");
...
//		repts.Verify_ReportHomePage("MODIFIER");
		...
		Thread.sleep(8000);
		//Verify the Modifiers page loaded or not
		//repts.Verify_ReportHomePage("DEPARTMENTS");
		try {
			if(driver.findElement(By.xpath("//li/span/a[contains(.,'Modifier')]")).isDisplayed()) {
				test.log(LogStatus.PASS, "Enterprise Modifier page is displayed");
			}
		}catch(Exception s) {
			test.log(LogStatus.FAIL, "Enterprise Modifier page is not getting loaded");
		}
	}
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Report_Modifier_Report_Today(SelfHealingDriver driver) throws Exception
	{
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
			...
			String SaleAmount=driver.findElement(By.xpath("//tfoot/tr/td[3]/div")).getText().replace(",", "");
			...
			//Get the Quantity
			String Qty=driver.findElement(By.xpath("//tfoot/tr/td[4]/div")).getText().replace(",", "");
			...
			//Get the Tax
			String Tx=driver.findElement(By.xpath("//tfoot/tr/td[5]/div")).getText().replace(",", "");
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Report_Modifier_Report_Yesterday(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Report_Modifier_Report_Last_N_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Report_Modifier_Report_This_Week(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Report_Modifier_Report_Last_Week(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Report_Modifier_Report_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Report_Modifier_Report_This_Month(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Report_Modifier_Report_Last_Month(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Report_Modifier_Report_Last_30_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Report_Modifier_Report_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Report_Modifier_Report_Date_Range(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
