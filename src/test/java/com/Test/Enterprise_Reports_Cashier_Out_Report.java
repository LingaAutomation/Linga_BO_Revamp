...
public class Enterprise_Reports_Cashier_Out_Report 
{
...
public SelfHealingDriver driver;
	...
	ExtentTest test = rep.startTest("Enterprise Reports - Cashier Out Report");
...
//		driver = new ChromeDriver();
	...
	{
		Open_Enterprise_Cashier_Out_Report_Page(driver);
//		RefreshAndPaginination(driver);
		Enterprise_Cashier_Out_Report_Today(driver);
		Enterprise_Cashier_Out_Report_Yesterday(driver);
		Enterprise_Cashier_Out_Report_Last_N_Days(driver);
		Enterprise_Cashier_Out_Report_This_Week(driver);
		Enterprise_Cashier_Out_Report_Last_Week(driver);
		Enterprise_Cashier_Out_Report_Last_7_Days(driver);
		Enterprise_Cashier_Out_Report_This_Month(driver);
		Enterprise_Cashier_Out_Report_Last_Month(driver);
		Enterprise_Cashier_Out_Report_Last_30_Days(driver);
		Enterprise_Cashier_Out_Report_Specific_Date(driver);
		Enterprise_Cashier_Out_Report_Date_Range(driver);
	}
	
	@Test(priority = 3,enabled = false)
	public void Open_Enterprise_Cashier_Out_Report_Page(SelfHealingDriver driver) throws Exception
	{
		...
		Thread.sleep(5000);
		//Load the Daily page
		driver.get(Utility.getProperty("baseURL")+"enterprise/enterpriseReports/saleReports/cashierOut");
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Cashier_Out_Report_Today(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//				excel.Highlight_DifferenceValue();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Cashier_Out_Report_Yesterday(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Enterprise_Report"));
...
//				excel.Highlight_DifferenceValue();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Cashier_Out_Report_Last_N_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Enterprise_Report"));
...
//				excel.Highlight_DifferenceValue();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Cashier_Out_Report_This_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Enterprise_Report"));
...
//				excel.Highlight_DifferenceValue();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Cashier_Out_Report_Last_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Enterprise_Report"));
...
//				excel.Highlight_DifferenceValue();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Cashier_Out_Report_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Enterprise_Report"));
...
//			excel.Highlight_DifferenceValue();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Cashier_Out_Report_This_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Enterprise_Report"));
...
//				excel.Highlight_DifferenceValue();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Cashier_Out_Report_Last_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Enterprise_Report"));
...
//				excel.Highlight_DifferenceValue();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Cashier_Out_Report_Last_30_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Enterprise_Report"));
...
//				excel.Highlight_DifferenceValue();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Cashier_Out_Report_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Enterprise_Report"));
...
//				excel.Highlight_DifferenceValue();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Cashier_Out_Report_Date_Range(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Enterprise_Report"));
