...
//		driver=new ChromeDriver(chrOpt);
	...
	public void Open_Modifier_Sales_Page(SelfHealingDriver driver) throws Exception
	{
	...
	public void Old_BO_Modifier_Report_Date_Range(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
