...
//		RefreshAndPaginination(driver);
	...
	public void Open_SaleSummary_Report_Page(SelfHealingDriver driver) throws Exception
	{
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void SaleSummary_Report_Today(SelfHealingDriver driver) throws Exception
	{
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void SaleSummary_Report_Yesterday(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void SaleSummary_Report_Last_N_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void SaleSummary_Report_This_Week(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void SaleSummary_Report_Last_Week(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void SaleSummary_Report_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void SaleSummary_Report_This_Month(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void SaleSummary_Report_Last_Month(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void SaleSummary_Report_Last_30_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void SaleSummary_Report_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_DOWN);
	...
	@Test(priority = 4,enabled = false)
	public void SaleSummary_Report_Date_Range(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
