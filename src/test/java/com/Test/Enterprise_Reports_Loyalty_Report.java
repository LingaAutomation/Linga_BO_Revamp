...
//		Verify_Enterprise_Loyalty_Report_Search_by_CustomerName(driver);
	...
	public void Open_Enterprise_Loyalty_Report_Page(WebDriver driver) throws Exception
	{
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void Verify_Enterprise_Loyalty_Report_Search_by_CustomerName(WebDriver driver) throws Exception
	{
...
//			
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Loyalty_Report_Today(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
int rowSize=rowList.size();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Loyalty_Report_Yesterday(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
int rowSize=rowList.size();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Loyalty_Report_Last_N_Days(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
int rowSize=rowList.size();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Loyalty_Report_This_Week(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
int rowSize=rowList.size();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Loyalty_Report_Last_Week(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
int rowSize=rowList.size();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Loyalty_Report_Last_7_Days(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
int rowSize=rowList.size();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Loyalty_Report_This_Month(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
int rowSize=rowList.size();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Loyalty_Report_Last_Month(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
int rowSize=rowList.size();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Loyalty_Report_Last_30_Days(WebDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
...
int rowSize=rowList.size();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Loyalty_Report_Specific_Date(WebDriver driver) throws Exception
	{
...
int rowSize=rowList.size();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Loyalty_Report_Date_Range(WebDriver driver) throws Exception
	{
