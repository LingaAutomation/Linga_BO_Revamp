...
//		driver=new ChromeDriver(chrOpt);
	...
	public void Open_SubCategory_Report_Page(SelfHealingDriver driver) throws Exception
	{
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void SubCategory_Report_Today(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//				excel.setreport_FailedData("Today", 41, 4,st);
	...
	@Test(priority = 4,enabled = false)
	public void SubCategory_Report_Yesterday(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Reports"));
...
//				excel.setreport_FailedData("Yesterday", 41, 4,st);
	...
	@Test(priority = 4,enabled = false)
	public void SubCategory_Report_Last_N_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Reports"));
...
//				excel.setreport_FailedData("Last N days", 41, 4,st);
	...
	@Test(priority = 4,enabled = false)
	public void SubCategory_Report_This_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Reports"));
...
//				excel.setreport_FailedData("This Week", 41, 4,st);
	...
	@Test(priority = 4,enabled = false)
	public void SubCategory_Report_Last_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Reports"));
...
//				excel.setreport_FailedData("Last Week", 41, 4,st);
	...
	@Test(priority = 4,enabled = false)
	public void SubCategory_Report_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Reports"));
...
//				excel.setreport_FailedData("Last 7 days", 41, 4,st);
	...
	@Test(priority = 4,enabled = false)
	public void SubCategory_Report_This_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Reports"));
...
//				excel.setreport_FailedData("This month", 41, 4,st);
	...
	@Test(priority = 4,enabled = false)
	public void SubCategory_Report_Last_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Reports"));
...
//				excel.setreport_FailedData("Last month", 41, 4,st);
	...
	@Test(priority = 4,enabled = false)
	public void SubCategory_Report_Last_30_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Reports"));
...
//				excel.setreport_FailedData("Last 30 days", 41, 4,st);
	...
	@Test(priority = 4,enabled = false)
	public void SubCategory_Report_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Reports"));
...
//				excel.setreport_FailedData("Specific Date", 41, 4,st);
	...
	@Test(priority = 4,enabled = false)
	public void SubCategory_Report_Date_Range(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Reports"));
