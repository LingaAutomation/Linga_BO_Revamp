...
public class Enterprise_Reports_Online_Sales_Report 
{
...
public SelfHealingDriver driver;
	...
	ExtentTest test = rep.startTest("Enterprise Reports - Online Sale Report");
...
//		driver = new ChromeDriver();
	...
	{
		Open_Enterprise_Online_Sales_Report_Page(driver);
//		RefreshAndPaginination(driver);
		Enterprise_Online_Sales_Report_Today(driver);
		Enterprise_Online_Sales_Report_Yesterday(driver);
		Enterprise_Online_Sales_Report_Last_N_Days(driver);
		Enterprise_Online_Sales_Report_This_Week(driver);
		Enterprise_Online_Sales_Report_Last_Week(driver);
		Enterprise_Online_Sales_Report_Last_7_Days(driver);
		Enterprise_Online_Sales_Report_This_Month(driver);
		Enterprise_Online_Sales_Report_Last_Month(driver);
		Enterprise_Online_Sales_Report_Last_30_Days(driver);
		Enterprise_Online_Sales_Report_Specific_Date(driver);
		Enterprise_Online_Sales_Report_Date_Range(driver);
	}
	
	@Test(priority = 3,enabled = false)
	public void Open_Enterprise_Online_Sales_Report_Page(SelfHealingDriver driver) throws Exception
	{
		...
		driver.get(Utility.getProperty("baseURL")+"enterprise/enterpriseReports/saleReports/onlineSales");
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Online_Sales_Report_Today(SelfHealingDriver driver) throws Exception
	{
		...
		catch(Exception G)
		{
			...
			for(int i = 1; i <= rowList.size();i++) {
				String NetSales=driver.findElement(By.xpath("//table/tbody/tr["+i+"]/td[9]")).getText().replace(",", "");
				double NetSales_Amount=Double.parseDouble(NetSales);

				String Discount=driver.findElement(By.xpath("//table/tbody/tr["+i+"]/td[10]")).getText().replace(",", "");
				double Discount_Amount=Double.parseDouble(Discount);
				
				String Tax=driver.findElement(By.xpath("//table/tbody/tr["+i+"]/td[11]")).getText().replace(",", "");
				double Tax_Amount=Double.parseDouble(Tax);
				
				String GrossReceipt=driver.findElement(By.xpath("//table/tbody/tr["+i+"]/td[14]")).getText().replace(",", "");
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Online_Sales_Report_Yesterday(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Online_Sales_Report_Last_N_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Online_Sales_Report_This_Week(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Online_Sales_Report_Last_Week(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Online_Sales_Report_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Online_Sales_Report_This_Month(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Online_Sales_Report_Last_Month(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Online_Sales_Report_Last_30_Days(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Online_Sales_Report_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Enterprise_Online_Sales_Report_Date_Range(SelfHealingDriver driver) throws Exception
	{
		for(int i = 1;i<=10;i++){driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);}
		Thread.sleep(1000);
		repts=new ReportsPage(driver, test);
