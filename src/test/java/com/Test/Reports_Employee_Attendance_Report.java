...
//		RefreshAndPaginination(driver);
	...
	public void Open_Employee_Attendance_Report_Page(SelfHealingDriver driver) throws Exception
	{
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_Verify_Employee_Attendance_Search(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_Today(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//			repts.Do_Pagination();
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_Yesterday(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_Last_N_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_This_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_Last_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_This_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_Last_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_Last_30_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Employee_Attendance_Report_Date_Range(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
