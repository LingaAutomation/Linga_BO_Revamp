...
public SelfHealingDriver driver;
	...
	ExtentTest test = rep.startTest("Reports - Void - Employee Report");
...
//		System.setProperty("webdriver.chrome.driver",Utility.getProperty("Chrome_Void_Employee_Path"));
...
//		RefreshAndPaginination(driver);
		...
		Void_Employee_Report_This_Week(driver);
		Void_Employee_Report_Last_Week(driver);
		Void_Employee_Report_Last_7_Days(driver);
		Void_Employee_Report_This_Month(driver);
		Void_Employee_Report_Last_Month(driver);
		Void_Employee_Report_Last_30_Days(driver);
		Void_Employee_Report_Specific_Date(driver);
		Void_Employee_Report_Date_Range(driver);
	}
	
	@Test(priority = 3,enabled = false)
	public void Open_Void_Employee_Report_Page(SelfHealingDriver driver) throws Exception
	{
		...
		Thread.sleep(5000);
		//Load the Daily page
		driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id3")+"voidReport/employee");
...
//		cmp.VerifyPagination_and_Refresh_Publish();
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_Verify_Void_Employee_Search(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		
//		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Void_Employee_Report"));
...
//			driver.findElement(By.tagName("html")).sendKeys(Keys.END);
		...
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
				...
				if(repts.No_TransactionFound_InfoMessage().isDisplayed())
				{
					test.log(LogStatus.INFO, "Void - Employees Not Available for Selected Time Period");
				...
				catch(Exception G)
				{
					...
					test.log(LogStatus.PASS, "Void - Employees Available for Selected Time Period");
...
//					List<WebElement> EmployeeList=driver.findElements(By.xpath("//div/select-option"));
//					int randomEmployee=ThreadLocalRandom.current().nextInt(2, EmployeeList.size());

					
					String Employee=driver.findElement(By.xpath("//div[2]/select-option")).getText();
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_Today(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//			repts.Do_Pagination();
		...
		if(rowSize<=1000)
		{
			for(int i=1;i<=rowSize;i++)
			{
				...
				String Item_Name=driver.findElement(By.xpath("//div[@class='data-grid']/div[3]/div["+i+"]/div/data-grid-row/div/div[3]")).getText();
				...
				String Void_Reason=driver.findElement(By.xpath("//div[@class='data-grid']/div[3]/div["+i+"]/div/data-grid-row/div/div[8]")).getText();

				String Void_By=driver.findElement(By.xpath("//div[@class='data-grid']/div[3]/div["+i+"]/div/data-grid-row/div/div[10]")).getText();
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_Yesterday(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
//		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Void_Employee_Report"));
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_Last_N_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Void_Employee_Report"));
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_This_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Void_Employee_Report"));
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_Last_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Void_Employee_Report"));
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Void_Employee_Report"));
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_This_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Void_Employee_Report"));
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_Last_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Void_Employee_Report"));
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_Last_30_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Void_Employee_Report"));
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//		ExcelDataConfig excel=new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_Void_Employee_Report"));
	...
	@Test(priority = 4,enabled = false)
	public void Void_Employee_Report_Date_Range(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
