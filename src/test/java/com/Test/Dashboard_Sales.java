...
//		driver=new ChromeDriver(chrOpt);
	...
	public void Dashboard_Sales_Today(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Sales_Yesterday(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
...
//				excel.setreport_FailedData("Yesterday", 42, 7,diff_value);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Sales_Last_N_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
...
//				excel.setreport_FailedData("Yesterday", 42, 7,diff_value);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Sales_This_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
...
//				excel.setreport_FailedData("Yesterday", 42, 7,diff_value);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Sales_Last_Week(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
...
//				excel.setreport_FailedData("Yesterday", 42, 7,diff_value);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Sales_Last_7_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
...
//				excel.setreport_FailedData("Yesterday", 42, 7,diff_value);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Sales_This_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
...
//				excel.setreport_FailedData("Yesterday", 42, 7,diff_value);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Sales_Last_Month(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
...
//				excel.setreport_FailedData("Yesterday", 42, 7,diff_value);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Sales_Last_30_Days(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
...
//				excel.setreport_FailedData("Yesterday", 42, 7,diff_value);
	...
	@Test(priority = 4,enabled = false)
	public void Dashboard_Sales_Specific_Date(SelfHealingDriver driver) throws Exception
	{
		repts=new ReportsPage(driver, test);
		cmp=new Common_XPaths(driver, test);
		db=new DashBoardPage(driver, test);
