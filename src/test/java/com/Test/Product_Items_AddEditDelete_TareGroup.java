...
//		driver=new ChromeDriver(chrOpt);
	...
	public void Open_TareGroups_Page(SelfHealingDriver driver) throws Exception
	{
	...
	@Test(priority = 4,enabled = false)
	public void Add_TareGroups(SelfHealingDriver driver) throws Exception
	{
		tgp=new TareGroupPage(driver, test);
		cmp=new Common_XPaths(driver, test);
	...
	public void Edit_and_Close_Cancel_TareGroups(SelfHealingDriver driver) throws Exception
	{
		cmp=new Common_XPaths(driver, test);
		tgp=new TareGroupPage(driver, test);
	...
	@Test(priority = 5,enabled = false)
	public void Edit_and_Update_TareGroups(SelfHealingDriver driver) throws Exception
	{
		cmp=new Common_XPaths(driver, test);
		tgp=new TareGroupPage(driver, test);
	...
	@Test(priority = 5,enabled = false)
	public void Delete_and_Active_Inactive_TareGroups(SelfHealingDriver driver) throws Exception
	{
		Thread.sleep(500);
	...
	public void Create_DuplicateTareGroup(SelfHealingDriver driver) throws Exception
	{
		tgp=new TareGroupPage(driver, test);
		cmp=new Common_XPaths(driver, test);
